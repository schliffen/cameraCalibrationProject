...
static cv::Point3f bkproj2d23d(cv::Point2f o2dPt, float afProjMat[12], int nLenUnit = 1000, int nCoordSysTyp = 1)
{

    // change projection matrix to an array to invert simply
...
static double get_rand_num(double min, double max, long seed)
{
